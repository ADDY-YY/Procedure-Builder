...
const dated=newDocument();dated.title='Dated';dated.purpose='Test';dated.procedures[0].title='Action';dated.procedures[0].steps[0].instruction='Complete the action.';dated.owner='2026-09-11';assert(renderHtml(dated).includes('September 11, 2026'));
