...
procedure:{label:'Procedure',description:'A consistent process, from start to finish.',groups:[group('support','Supporting resources',['Supporting Resources','Contacts']),group('revision','Revision information',['Revision History','Last Reviewed','Revision Information'])]},
