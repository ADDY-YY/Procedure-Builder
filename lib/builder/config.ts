...
procedure:{label:'Procedure',description:'A consistent process, from start to finish.',groups:[group('support','Supporting resources',['Supporting Resources','Contacts']),group('revision','Revision information',['Revision History','Last Reviewed','Initial Release','Revision Information'])]},
'how-to':{label:'How-To',description:'Help someone complete a specific task.',groups:[group('purpose_details','Purpose',['Use this article when','Error message / situation','User need']),group('before_you_start','Before You Start',['Required access','Required apps / setup','Pre-steps']),group('troubleshooting','If Something Doesn’t Work',['Do this','If issue']),group('important_notes','Important Notes',['Important Notes']),group('need_help','Need Help',['Submit a ticket','Contact team','Link to procedure'])]},
