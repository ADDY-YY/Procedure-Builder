...
'how-to':{label:'How-To',description:'Help someone complete a specific task.',groups:[group('before_you_start','Before You Start',['Before you start']),group('troubleshooting','If Something Doesn’t Work',['Do this','If issue']),group('important_notes','Important Notes',['Important Notes']),group('need_help','Need Help',['Submit a ticket','Contact team','Link to procedure'])]},
